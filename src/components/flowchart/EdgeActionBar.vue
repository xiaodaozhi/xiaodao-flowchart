<template>
  <Transition name="bar">
    <div v-if="visible" class="edge-action-bar">
      <div class="bar-inner" ref="barRef">
        ...
        <div class="color-scroll" ref="scrollRef">
          <div class="color-row">
            <button
              ...
              :title="c === defaultColor ? i18n.t('edge.defaultColor') : c"
        ...
        <!-- Delete button -->
        <button class="delete-btn" :title="i18n.t('edge.delete')" @click="$emit('delete')">
...
import { EDGE_PRESET_COLORS, EDGE_DEFAULT_COLOR } from '../../utils/colorUtils'
...
const activeColor = computed(() => {
  ...
  if (!c || c === EDGE_DEFAULT_COLOR) return EDGE_DEFAULT_COLOR
  return c
})
