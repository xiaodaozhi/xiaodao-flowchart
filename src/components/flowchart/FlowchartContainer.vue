...
function handleDelete() {
  ...
  if (selection.selectedNodeId.value) { model.removeNode(selection.selectedNodeId.value); selection.clearSelection() }
  else if (selection.selectedEdgeId.value) { model.removeEdge(selection.selectedEdgeId.value); selection.clearSelection() }
}
